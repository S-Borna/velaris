...
const MOCK_CONVERSATIONS: Conversation[] = [
    { id: "conv1", leadName: "Noor El-Amin", leadTitle: "Co-Founder", leadCompany: "[redacted]", leadAvatar: "NE", linkedinAccountName: "Said Borna", linkedinAccountAvatar: "SB", lastMessage: "That sounds great! Let's set up a call next week.", lastMessageAt: "2 min ago", lastMessageDirection: "received", status: "unread", unreadCount: 2, sentiment: "positive", campaignName: "SaaS Founders Europe", note: "High priority — VC co-founder" },
    { id: "conv2", leadName: "Amir Kessler", leadTitle: "Co-Founder & CEO", leadCompany: "Flowmatic", leadAvatar: "AK", linkedinAccountName: "Said Borna", linkedinAccountAvatar: "SB", lastMessage: "Thanks for reaching out! I'm curious about what you're building.", lastMessageAt: "15 min ago", lastMessageDirection: "received", status: "unread", unreadCount: 1, sentiment: "positive", campaignName: "Outreach to Agency Owners", note: null },
    ...
    { id: "conv4", leadName: "Tomas Richter", leadTitle: "Head of Growth", leadCompany: "N26", leadAvatar: "TR", linkedinAccountName: "Said Borna", linkedinAccountAvatar: "SB", lastMessage: "Hi Tomas, I wanted to follow up on our conversation last week. Are you still interested in exploring this further?", lastMessageAt: "3 hours ago", lastMessageDirection: "sent", status: "read", unreadCount: 0, sentiment: null, campaignName: "SaaS Founders Europe", note: null },
...
const MOCK_MESSAGES: Record<string, Message[]> = {
    conv1: [
        { id: "m1", conversationId: "conv1", direction: "sent", content: "Hi Noor! I came across [redacted] and I'm really impressed with the portfolio. I'm building an AI-powered LinkedIn automation platform and would love to get your thoughts.", timestamp: "Yesterday 10:30 AM", type: "connection_request", read: true },
    ...
    conv2: [
        { id: "m7", conversationId: "conv2", direction: "sent", content: "Hi Amir! Fellow LinkedIn automation builder here 👋 Would love to connect and exchange ideas.", timestamp: "Today 8:00 AM", type: "connection_request", read: true },
...
const AI_SUGGESTIONS: Record<string, AiSuggestion[]> = {
    conv1: [
        { text: "Thanks Noor! How about Tuesday or Wednesday? I have openings at 10 AM and 2 PM CET.", tone: "Professional" },
    ...
    conv2: [
        { text: "Thanks Amir! We're building Velaris — an AI-powered LinkedIn automation platform. Would love to exchange notes since you're in the same space.", tone: "Professional" },
