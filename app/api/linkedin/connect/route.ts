...
const INTERNAL_ERROR_MESSAGE = "Failed to send connection request. Please try again.";
...
export async function POST(request: Request): Promise<NextResponse> {
  try {
    ...
    console.error("[LinkedIn Connect API]", error instanceof Error ? error.message : "Unknown error");
